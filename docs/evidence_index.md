...
- **Each case study is a single, unreproduced observation.** CS-001 had no access to the system's internals. CS-002 did not record the configuration in use.
